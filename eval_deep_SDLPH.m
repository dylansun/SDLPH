...
result_file = ['result_sdlph/deep_sdlph_result_' num2str(nbits) '_bits_r_' num2str(hammRadius) '_iter_' num2str(last_iter + maxItr) '.mat'];
save(result_file, 'mPrecision', 'MAP', 'B','tB', 'hammTrainTest', 'Pre','Rec', 'precisions', 'recalls', 'B_init');
end